...
class _CadProState extends State<CadPro> {
  ...
  Future<void> salvarNoFirestore() async {
    try {
      ...
      mostrarSnackBar(
        context: context,
        texto: "Processo salvo com sucesso",
                      ...
                      color:
                          isActive
                              ...
                              ? const Color.fromARGB(
                                ...
                                23,
                                59,
                              ) // Cor para o passo concluído (vinho mais escuro)
                              : (dark
                                  ? Colors.grey[800]
                                  : const Color(0xffE0D3CA)), // Cor padrão
                      border: Border.all(
                        color:
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    dark
                        ? Colors.grey[800]
                        : const Color(0xffE0D3CA).withOpacity(0.3),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color:
                      dark
                          ? Colors.grey[700]!
                          : const Color(0xFF490A1D).withOpacity(0.2),
                ),
              ),
              child: Text(
            ...
            decoration: BoxDecoration(
              color:
                  dark
                      ...
                      : Colors.white, //Botões fixos na parte inferior
              boxShadow: [
                BoxShadow(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        shadowColor:
                            dark
                                ? Colors.transparent
                                : const Color.fromARGB(255, 64, 27, 39),
